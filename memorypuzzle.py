...
class Board:
    ...
    def printClicks(self):
        ...
        #undo = clicksFont.render(str(29 - self.totalClicks),False, BGColor)
        clicks = clicksFont.render("Clicks Remaining: ", False, WHITE)
        clickvar = clicksFont.render(str(25- self.totalClicks),False, WHITE)
        pygame.draw.rect(self.screen, BGColor, (10,30,30,20))
    ...
    def printPoints(self):
        ...
        pygame.draw.rect(self.screen, BGColor, (250,30,30,20))
